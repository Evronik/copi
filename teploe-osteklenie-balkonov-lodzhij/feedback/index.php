...
$form['form-1'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Заявка с сайта Лучшие окна',
		'title' => 'Свяжитесь с клиентом',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'noreply@email.com',
		'from_name' => 'Лучшие окна',
		'to_email' => 'hemerges@mail.ru',
		'to_name' => 'Eko',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
		...
		'okay' => 'Заявка отправлена!<br> Ждите связи с менеджером.',
